...
if (class_exists('BABE_Functions')) {
	...
	<div class="case-multi-isotope-1 rt-isotope-wrapper">
			...
			<div class="d-flex view-switch-right">
				...
				<ul class="nav" id="pills-tab" role="tablist">
					<li class="nav-item" role="presentation">
						<button class="nav-btn active" id="pills-grid-tab" data-bs-toggle="pill" data-bs-target="#pills-grid" type="button" role="tab" aria-controls="pills-grid" aria-selected="true">
					...
					<li class="nav-item" role="presentation">
						<button class="nav-btn" id="pills-list-tab" data-bs-toggle="pill" data-bs-target="#pills-list" type="button" role="tab" aria-controls="pills-list" aria-selected="false">
							<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
