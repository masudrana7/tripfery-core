...
?>
<div class="rt-team-default rt-team-multi-layout-2 team-grid-<?php echo esc_attr($data['style']); ?>">
						...
						<div class="team-content-wrap">
							...
							<?php if (!empty($socials) && $data['social_display']  == 'yes') { ?>
								<ul class="team-social">
									<li class="social-item"><a href="#" class="social-hover-icon social-link" aria-label="Social Share"><i class="fa-solid fa-share-nodes"></i></a>
