...
class RT_Service extends Custom_Widget_Base {
	...
	public function __construct( $data = [], $args = null ){
		$this->rt_name = esc_html__( 'RT Service', 'tripfery-core' );
	...
	public function rt_fields(){
		$terms = get_terms( array( 'taxonomy' => 'tripfery_service_category', 'fields' => 'id=>name' ) );
		...
		$fields = array(
			...
			array(
				...
				'options' => array(
					'style1' => esc_html__( 'Service Grid 1', 'tripfery-core' ),
					'style2' => esc_html__( 'Service Grid 2', 'tripfery-core' ),
					'style3' => esc_html__( 'Service Grid 3', 'tripfery-core' ),
					'style6' => esc_html__( 'Service Grid 4', 'tripfery-core' ),
					'style4' => esc_html__( 'Service Slider 1', 'tripfery-core' ),
					'style5' => esc_html__( 'Service Slider 2', 'tripfery-core' ),
					'style7' => esc_html__( 'Service Slider 3', 'tripfery-core' ),
				),
				'default' => 'style1',
			),
			array(
			...
			array(
				...
				'default' => esc_html__( 'More Services', 'tripfery-core' ),
			...
			array(
				'type'        => Controls_Manager::SWITCHER,
				'id'          => 'icon_display',
				'label'       => esc_html__( 'Icon Display', 'tripfery-core' ),
				'label_on'    => esc_html__( 'On', 'tripfery-core' ),
				'label_off'   => esc_html__( 'Off', 'tripfery-core' ),
				'default'     => 'yes',
				'description' => esc_html__( 'Show or Hide Icon. Default: On', 'tripfery-core' ),
			),
			array(
				'type'        => Controls_Manager::SWITCHER,
				'id'          => 'action_display',
				...
				'label_off'   => esc_html__( 'Off', 'tripfery-core' ),
				'default'     => 'yes',
				'description' => esc_html__( 'Show or Hide Action. Default: On', 'tripfery-core' ),
			),
			array(
				'type'        => Controls_Manager::SWITCHER,
				'id'          => 'vactor_display',
			...
			array(
				'type'        => Controls_Manager::SWITCHER,
				'id'          => 'counter_display',
				'label'       => esc_html__( 'Counter Display', 'tripfery-core' ),
				'label_on'    => esc_html__( 'On', 'tripfery-core' ),
				'label_off'   => esc_html__( 'Off', 'tripfery-core' ),
				'default'     => 'no',
				'description' => esc_html__( 'Show or Hide Action. Default: Off', 'tripfery-core' ),
			...
			array(
				'mode'    => 'section_start',
				'id'      => 'sec_item_box',
				'label'   => esc_html__( 'Item Box', 'tripfery-core' ),
				'tab'     => Controls_Manager::TAB_STYLE,
			),			
			array(
