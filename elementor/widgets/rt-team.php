...
class RT_Team extends Custom_Widget_Base {
	...
	public function __construct( $data = [], $args = null ){
		$this->rt_name = esc_html__( 'RT Team', 'tripfery-core' );
	...
	public function rt_fields(){
		$terms = get_terms( array( 'taxonomy' => 'tripfery_team_category', 'fields' => 'id=>name' ) );
		...
		$fields = array(
			...
			array(
				...
				'options' => array(
					'style1' => esc_html__( 'Team Grid 1', 'tripfery-core' ),
					'style2' => esc_html__( 'Team Grid 2', 'tripfery-core' ),
					'style3' => esc_html__( 'Team Grid 3', 'tripfery-core' ),
					'style4' => esc_html__( 'Team Grid 4', 'tripfery-core' ),
					'style8' => esc_html__( 'Team Grid 5', 'tripfery-core' ),
					'style5' => esc_html__( 'Team Slider 1', 'tripfery-core' ),
					'style6' => esc_html__( 'Team Slider 2', 'tripfery-core' ),
					'style7' => esc_html__( 'Team Slider 3', 'tripfery-core' ),
					'style9' => esc_html__( 'Team Slider 4', 'tripfery-core' ),
				),
				'default' => 'style1',
			),
			array(
			...
			array(
				...
				'default' => 'g-4',
				'condition'   => array( 'style' => array( 'style1', 'style2', 'style3', 'style4', 'style8' ) ),
			),			
			array(
				'type'    => Controls_Manager::SELECT2,
				'id'      => 'cat',
			...
			array(
				...
				'default' => esc_html__( 'More Teams', 'tripfery-core' ),
				'condition'   => array( 'more_button' => array( 'show' ), 'style' => array( 'style1', 'style2', 'style3', 'style4', 'style8' ) ),
			),
			array(
				'type'    => Controls_Manager::TEXT,
				'id'      => 'see_button_link',
	        ...
	        array(
				...
				'selector' => '{{WRAPPER}} .rt-team-default .team-title',
			),
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .rt-team-default .team-title' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				),
			),
			array(
			...
			array(
				...
				'label'       => esc_html__( 'Designation Display', 'tripfery-core' ),
				'label_on'    => esc_html__( 'On', 'tripfery-core' ),
				'label_off'   => esc_html__( 'Off', 'tripfery-core' ),
				'default'     => 'yes',
				'description' => esc_html__( 'Show or Hide Designation. Default: On', 'tripfery-core' ),
			),
			array(
				'type'        => Controls_Manager::SWITCHER,
				'id'          => 'social_display',
				'label'       => esc_html__( 'Social Media Display', 'tripfery-core' ),
				'label_on'    => esc_html__( 'On', 'tripfery-core' ),
				'label_off'   => esc_html__( 'Off', 'tripfery-core' ),
				'default'     => 'yes',
				'description' => esc_html__( 'Show or Hide Social Medias. Default: On', 'tripfery-core' ),
			),
			array(
	            ...
	            'size_units' => [ 'px', '%', 'em' ],
	            'id'      => 'social_radius',
	            'label'   => __( 'Social Radius', 'tripfery-core' ),                 
	            'selectors' => array(
	                '{{WRAPPER}} .rt-team-default .team-social .social-item a' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',                 
	            ),
	            'separator' => 'before',
	        ),
			array(
	        ...
	        array(
				...
				'default' => '',
				'selectors' => array(
					'{{WRAPPER}} .rt-team-default .team-title a' => 'color: {{VALUE}}',
				),
			),
	        array(
				'type'    => Controls_Manager::COLOR,
				...
				'default' => '',
				'selectors' => array(
					'{{WRAPPER}} .rt-team-default .team-designation' => 'color: {{VALUE}}',
				),
			),
	        array(
				'type'    => Controls_Manager::COLOR,
				...
				'default' => '',
				'selectors' => array(
					'{{WRAPPER}} .rt-team-default .team-content' => 'color: {{VALUE}}',
				),
			),
	        array(
				'type'    => Controls_Manager::COLOR,
				...
				'default' => '',
				'selectors' => array(
					'{{WRAPPER}} .rt-team-multi-layout-1 .team-item .team-content' => 'background-color: {{VALUE}}',
					'{{WRAPPER}} .rt-team-multi-layout-2 .team-content-wrap .team-content' => 'background-color: {{VALUE}}',
					'{{WRAPPER}} .rt-team-multi-layout-3 .image-content-wrap' => 'background-color: {{VALUE}}',
					'{{WRAPPER}} .rt-team-multi-layout-4 .team-content-wrap .team-content' => 'background-color: {{VALUE}}',
				),
			...
			array(
				...
				'id'      => 'box_radius',
				'mode'    => 'responsive',
				'label'   => esc_html__( 'Box Radius', 'tripfery-core' ),
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .rt-team-default .team-content-wrap .team-thums' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .rt-team-multi-layout-3 .team-content-wrap' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			),			
			array(
	            'type'    => Controls_Manager::DIMENSIONS,
	            ...
	            'size_units' => [ 'px', '%', 'em' ],
	            'id'      => 'content_radius',
	            'label'   => __( 'Content Radius', 'tripfery-core' ),                 
	            'selectors' => array(
	                '{{WRAPPER}} .rt-team-default .team-content' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',                 
	            ),
	            'separator' => 'before',
				'condition'   => array( 'style!' => array( 'style8', 'style9' ) ),
	        ),
			array(
				'type'        => Controls_Manager::SWITCHER,
				'id'          => 'vactor_display',
				'label'       => esc_html__( 'Vactor Display', 'tripfery-core' ),
				'label_on'    => esc_html__( 'On', 'tripfery-core' ),
				'label_off'   => esc_html__( 'Off', 'tripfery-core' ),
				'default'     => 'yes',
				'description' => esc_html__( 'Show or Hide Vactor. Default: On', 'tripfery-core' ),
				'condition'   => array( 'style' => array( 'style8', 'style9' ) ),
			),
	        array(
				'type'    => Controls_Manager::COLOR,
				'id'      => 'vactor_color',
				'label'   => esc_html__( 'Vactor Color', 'tripfery-core' ),
				'default' => '',
				'selectors' => array(
					'{{WRAPPER}} .rt-team-multi-layout-5 .team-content svg' => 'color: {{VALUE}}',
				),
				'condition'   => array( 'style' => array( 'style8', 'style9' ), 'vactor_display' => array( 'yes' ) ),
			),
			array(
				'mode' => 'section_end',
			),
			...
			array(
				...
				'tab'     => Controls_Manager::TAB_STYLE,
				'condition'   => array( 'style' => array( 'style5', 'style6', 'style7', 'style9' ) ),
			),
			array(
				'type'        => Controls_Manager::SWITCHER,
				'id'          => 'display_arrow',
	...
	protected function render() {
		...
		switch ( $data['style'] ) {
			...
			$template = 'rt-team-slider-4';
			break;
			case 'style7':
			$data['swiper_data'] = json_encode( $swiper_data );
			$template = 'rt-team-slider-3';
			break;
			case 'style6':
			$data['swiper_data'] = json_encode( $swiper_data );
			$template = 'rt-team-slider-2';
			break;
			case 'style5':
			$data['swiper_data'] = json_encode( $swiper_data );
			$template = 'rt-team-slider-1';
			break;
			case 'style8':
			$template = 'rt-team-grid-5';
			break;
			case 'style4':
			$template = 'rt-team-grid-4';
			break;
			case 'style3':
			$template = 'rt-team-grid-3';
			break;
			case 'style2':
			$template = 'rt-team-grid-2';
			break;
			default:
			$template = 'rt-team-grid-1';
			break;
		}		
