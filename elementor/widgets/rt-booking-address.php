...
class RT_Booking_Address extends Custom_Widget_Base
{
	public function __construct($data = [], $args = null)
	{
		$this->rt_name = esc_html__('BA Booking Address', 'tripfery-core');
		$this->rt_base = 'rt-booking-address';
	...
	public function rt_fields()
	{
		$fields = array(
			array(
				'mode'    => 'section_start',
				'id'      => 'sec_general',
				'label'   => esc_html__('BA Booking Address', 'tripfery-core'),
			),
			array(
				'mode' => 'section_end',
			),
			...
			array(
				...
				'default' => '',
				'selectors' => array(
					'{{WRAPPER}} .address-icon i' => 'color: {{VALUE}}',
				),
			),
			...
			array(
				...
				'size_units' => ['px', '%'],
				'selectors' => [
					'{{WRAPPER}} .rt-booking-address' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			),
