...
class RT_BE_Price_Filter extends Custom_Widget_Base {
	public function __construct( $data = [], $args = null ){
		$this->rt_name = esc_html__( 'BA Price Filter', 'tripfery-core' );
		$this->rt_base = 'rt-be-price-filer';
