...
class RT_Booking_Price extends Custom_Widget_Base
{
	public function __construct($data = [], $args = null)
	{
		$this->rt_name = esc_html__('BA Booking Price', 'tripfery-core');
	...
	public function rt_fields()
	{
		$fields = array(
			array(
				'mode'    => 'section_start',
				'id'      => 'sec_general',
				'label'   => esc_html__('BA Booking Price', 'tripfery-core'),
			),
			array(
				'mode' => 'section_end',
			),
